...
class SuggestionScreen extends StatefulWidget {
  const SuggestionScreen({Key? key, this.userData}) : super(key: key);
  // ignore: prefer_typing_uninitialized_variables
  final userData;

  @override
  State<SuggestionScreen> createState() => _SuggestionScreen();
}
...
class _SuggestionScreen extends State<SuggestionScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: BackAndCloseAppBar(text: "ข้อเสนอแนะจากผู้ใช้งาน"),
                        ...
                        child: Column(children: [
                          BasicCard(
                            ...
                            text: StringUtils.capitalize(
                                data[index]['suggestHeader']),
                            onTab: () {
                              showDialog(
                                context: context,
                                builder: (BuildContext context) =>
                                    SuggestDetailPage(data[index]),
                              );
                            },
                          ),
                        ]),
