...
class ManageLevelScreenBody extends StatefulWidget {
  const ManageLevelScreenBody({Key? key, this.userData}) : super(key: key);
  // ignore: prefer_typing_uninitialized_variables
  final userData;

  @override
  State<ManageLevelScreenBody> createState() => _ManageLevelScreenBody();
}

class _ManageLevelScreenBody extends State<ManageLevelScreenBody> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: BackAndCloseAppBar(text: "การจัดการระดับภาษา"),
        ...
        SizedBox(
          ...
          child: StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              ...
              var data = snapshot.data!.docs[2];
              return ListView.builder(
                padding: const EdgeInsets.symmetric(
                    vertical: 20.0, horizontal: 20.0),
                itemCount: data['levelLanguages'].length,
